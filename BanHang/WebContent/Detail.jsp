            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="card bg-light mb-3">
                        ...
                        <div class="card-body">
                            <img class="img-fluid" src="${dsgiay.image}" />
                            <h5 class="card-title">Tên</h5>
                            <p class="card-text">Mô tả</p>
                            <p class="bloc_left_price">Ảnh</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-9">
                            ...
                            <div class="row">
                                <aside class="col-sm-5 border-right">
                                    <article class="gallery-wrap"> 
                                        <div class="img-big-wrap">
                                            <div> <a href="#"><img src="${dsgiay.image}"></a></div>
                                        </div> <!-- slider-product.// -->
                                ...
                                <aside class="col-sm-7">
                                    <article class="card-body p-5">
                                        <h3 class="title mb-3">${dsgiay.name}</h3>

                                        <p class="price-detail-wrap"> 
                                            <span class="price h3 text-warning"> 
                                                <span class="currency">US $</span><span class="num">${dsgiay.price}</span>
                                            </span> 
                                            <!--<span>/per kg</span>--> 
                                        </p> <!-- price-detail-wrap .// -->
                                        <dl class="item-property">
                                            <dt>Description</dt>
                                            <dd><p>${dsgiay.description} </p></dd>
                                        </dl>

                    ...
                    <tbody>
                        <c:forEach items="${dsgiay}" var="o">
                            <tr>
                                ...
                                <td>${o.price} $</td>
                                <td>
                                    <a href="loadEdit?pid=${o.id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                ...
                <div class="modal-content">
                    <form action="addProduct" enctype="multipart/form-data" method="post">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                <label>Title</label>
                                <textarea name="txttitle" class="form-control" required></textarea>
                            </div>
                            <div class="form-group">

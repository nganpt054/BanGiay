...
<html>
    ...
    <body>
		...
		%>
                        <li class="nav-item">
                            <a class="nav-link" href="adminKHController">QL khách hàng</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="adminLoai">QL loại sản phẩm</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="htSanPham">QL sản phẩm</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="htDonHang">QL đơn hàng</a>
                        </li>
		 ...
		 <li class="nav-item"><a class="nav-link" href="dangxuatController"> Đăng Xuất</a></li>
           ...
           <li class="nav-item">
                             ...
                             <a class="nav-link" href="LoginAdmin.jsp">Login</a> 
                        </li>
